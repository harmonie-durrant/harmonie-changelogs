 ...
 */ (function(g, f) {
    $90482e2fcda9b250$exports = f();
})(typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : $90482e2fcda9b250$exports, function() {
    var exports = {};
    ...
    var Te = (a, e)=>{
        for(var t in e)G(a, t, {
            get: e[t],
            enumerable: !0
        });
    }, we = (a, e, t, n)=>{
        if (e && typeof e == "object" || typeof e == "function") for (let r of Re(e))!Oe.call(a, r) && r !== t && G(a, r, {
            get: ()=>e[r],
            enumerable: !(n = be(e, r)) || n.enumerable
        });
        return a;
    };
    var ye = (a)=>we(G({}, "__esModule", {
            value: !0
        }), a);
    var dt = {};
    Te(dt, {
...
`, e = e.substring(k.length + 1), u = !0), !u) {
                        let H = this.rules.other.nextBulletRegex(g), te = this.rules.other.hrRegex(g), ne = this.rules.other.fencesBeginRegex(g), re = this.rules.other.headingBeginRegex(g), xe = this.rules.other.htmlBeginRegex(g);
                        for(; e;){
                            let Z = e.split(`
`, 1)[0], E;
                            if (k = Z, this.options.pedantic ? (k = k.replace(this.rules.other.listReplaceNesting, "  "), E = k) : E = k.replace(this.rules.other.tabCharGlobal, "    "), ne.test(k) || re.test(k) || xe.test(k) || H.test(k) || te.test(k)) break;
...
` + k;
                            ...
                            !R && !k.trim() && (R = !0), p += Z + `
`, e = e.substring(Z.length + 1), f = E.slice(g);
                        }
                    }
                ...
                if (n.hooks) {
                    ...
                    for(let s in n.hooks){
                        ...
                        S.passThroughHooks.has(s) ? i[o] = (p)=>{
                            if (this.defaults.async && S.passThroughHooksRespectAsync.has(s)) return Promise.resolve(l.call(i, p)).then((f)=>u.call(i, f));
                            let c = l.call(i, p);
                            return u.call(i, c);
                        } : i[o] = (...p)=>{
                            let c = l.apply(i, p);
...
class $5e992beb3636530b$export$abf9e6a64b1b3473 extends HTMLElement {
    ...
    constructor(){
        ...
        this._md = (0, $90482e2fcda9b250$exports.marked).parse;
        if (!this._md) console.warn('Markdown parser not available');
        else try {
    ...
    render() {
        ...
        if (changelogContent) {
            if (typeof this._md === 'function' && state.state) try {
            ...
            else changelogContent.innerHTML = state.state ? state.state.replace(/\n/g, '<br>') : '';
        }
